...
import { sellProducts as RsellProducts } from '@/services/User';

const ProductSell = ({ selectedUser, setSelectedUser }) => {
    ...
    const doBuyProducts = async () => {
        try {
            const { data } = await RsellProducts({ user_id: selectedUser._id, time: time.format(), cardPrice, selectedProducts });
    ...
    return (
        <>
            ...
            <Input placeholder={"جستجو بر اساس نام"} inputCssClass={"text-center ltr"}
